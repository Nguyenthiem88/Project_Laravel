...
<!-- Site Metas -->
<title>SmartEDU - Blog-single</title>
            ...
            <div class="col-lg-9 blog-post-single">
                <div class="blog-item">
                    <div class="image-blog">
                        <img src="/admin/images/blog_single.jpg" alt="" class="img-fluid">
                    </div>
                ...
                <div class="blog-author">
                    ...
                    <div class="author-desc">
                        <img src="/admin/images/author.jpg" alt="about author">
                ...
                <div class="blog-comments">
                    ...
                    <div id="comment-blog">
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="avatar"><img alt="" src="/admin/images/avatar-01.jpg" class="avatar"></div>
                            ...
                            <li class="comment">
                                <div class="avatar"><img alt="" src="/admin/images/avatar-02.jpg" class="avatar"></div>
                                <div class="comment-container">
                                    <h5 class="comment-author"><a href="#">John Smith</a></h5>
                                    <div class="comment-meta">
                                        <a href="#" class="comment-date link-style1">February 22, 2015</a>
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="avatar"><img alt="" src="/admin/images/avatar-03.jpg" class="avatar"></div>
                                        <div class="comment-container">
